...
const authStore = useAuthStore();
 const task = taskStore.selectTaskById?.[0];
  ...
  <div class="shadow-lg rounded-xl min-w-full  px-4 bg-white flex flex-col relative  overflow-hidden">
    <div class="flex items-center justify-center p-12">
      <div class="mx-auto w-full max-w-[550px]">
        <div class="text-center mb-3"><span class="text-xl  text-black font-bold">Update Task</span></div>
        <form @submit.prevent="updateTaskHandler">
            ...
            <div class="w-full px-3 sm:w-1/2">
              <div class="mb-5">
                ...
                <select id="priority" v-model="form.priority"
                  class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-blakc outline-none focus:border-primary focus:shadow-md">
          ...
          <div class="flex justify-end">
            <button :disabled="taskStore.isLoading" class="hover:shadow-form rounded-xl disabled:bg-secondary-100 disabled:cursor-not-allowed bg-primary hover:bg-secondary-600 py-3 px-8 text-center text-base font-semibold text-white outline-none">
              ...
              <span v-show="!taskStore.isLoading">Update</span>
            </button>
          </div>
        </form>
      </div>
